...
GROCY_API_KEY = "your_default_key"  # Replace with dynamic input if needed
GROCY_URL = "http://your_default_url"  # Replace with dynamic input if needed
...
def scan():
    ...
    try:
        ...
        grocy_response.raise_for_status()  # Raise an exception for HTTP errors
    except requests.RequestException as e:
